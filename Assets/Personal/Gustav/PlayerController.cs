...
public class PlayerController : MonoBehaviour {
        ...
        private Vector2 CalculateMovement(Vector2 moveVector) { // can possible be solved through the input manager/input actions thingy
                Vector2 signedMovement = new Vector2( moveVector.x == 0 ? 0 : Mathf.Sign(moveVector.x), moveVector.y == 0 ? 0 : Mathf.Sign(moveVector.y));
