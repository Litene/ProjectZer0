...
public class TNew3rdCam : MonoBehaviour {
    ...
    [SerializeField, Tooltip("A point which the camera interpolates towards.")] private Transform leftPoint, rightPoint, farPoint;
    [SerializeField, Tooltip("The point which the camera looks towards.")] private Transform lookTarget;
    [Header("Player Character")]
    [SerializeField, Tooltip("A reference to the player character.")] private GameObject player;
    ...
    [Range(5f, 20f)]public float smoothingFactor = 10f;
    ...
    private void LateUpdate() {
        switch (currentFocusPoints.Count) {
            ...
            case 0:
                ...
                transform.position = Vector3.SmoothDamp(transform.position, _currentTargetPoint.position, ref _velRef, _smoothing * smoothingFactor * Time.deltaTime);
